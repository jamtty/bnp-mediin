    ...
    <div id="footer">
      <div className="section">
        <div className="foot_cont">
          <div className="foot_menu">
            <button
              type="button"
              className="foot_btn"
              onClick={() => onOpenPopup('hospital_ethics')}
            >
              병원윤리강령
            </button>
            <button
              type="button"
              className="foot_btn"
              onClick={() => onOpenPopup('rights_responsibilities')}
            >
              환자의 권리와 의무
            </button>
            ...
            <Link to="/about/location" className="foot_btn">
              오시는 길
            </Link>
          </div>
        ...
        <div className="foot_sns">
          <a
            href="https://blog.naver.com/kweonth"
            target="_blank"
            rel="noreferrer"
            title="메디인병원 네이버 블로그 바로가기"
          >
            <img src={icoNaver} alt="네이버" />
          </a>
          <a
            href="https://www.instagram.com/mediyin2022/"
            target="_blank"
            rel="noreferrer"
            title="메디인병원 인스타그램 바로가기"
          >
            <img src={icoInsta} alt="인스타그램" />
          </a>
          <a
            href="https://www.youtube.com/channel/UCFuKObVcsHzl0fwg51TH6BQ"
            target="_blank"
            rel="noreferrer"
            title="메디인병원 유튜브 바로가기"
          >
            <img src={icoYoutube} alt="유튜브" />
          </a>
        </div>
      </div>
    </div>
