...
function DoctorListSection({ doctors, loading, onShowSchedule, currentDeptName }: { doctors: DoctorItem[]; loading: boolean; onShowSchedule: (d: DoctorItem) => void; currentDeptName: string }) {
...
export default function ClinicDetailPage() {
  ...
  return (
    ...
    >
      <h3 className="cont_tit">{clinicName}</h3>
        ...
        {code === 'endoscopy' && (
          <>
            <div className="con_area">
              <div className="cont_area active_cont">
          ...
          <>
            <div className="con_area">
              ...
              <div className={outerTab === 'out_tab02' ? 'cont_area active_cont' : 'cont_area'}>
                <DoctorListSection doctors={doctors} loading={loadingDocs} onShowSchedule={setScheduleDoctor} currentDeptName={clinicName ?? ""} />
              </div>
            </div>
          </>
        )}
    ...
    {scheduleDoctor && (
      <DoctorScheduleModal doctor={scheduleDoctor} onClose={() => setScheduleDoctor(null)} currentDeptName={clinicName ?? ""} />
    )}
    </>
  )
}
