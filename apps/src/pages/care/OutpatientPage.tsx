...
export default function OutpatientPage() {
    return (
        <SubPageLayout visualClass="vs1" visualTitle="진료안내" lnbItems={lnbItems}>
                ...
                <div className="reserv_info_area">
                    <div className="info_time_sec">
                        ...
                        <p className="info_disc">
                            외래 접수 시간은 환자수에 따라 다소 조정될 수 있습니다.{' '}
                    ...
                    <div className="info_step_sec">
                        ...
                        <div className="info_step_area">
                            <div className="step_box1 m_hide">
                                ...
                                <div className="box line_box arrow_box"><strong>입원결정서 발급</strong></div>
                                <div className="box">
                                    <dl className="bd_box">
                                ...
                                <div className="step_next"><span>당일접수<br />전화예약</span></div>
                            </div>
                            <div className="step_box2 m_hide">
                                ...
                                <div className="box line_box arrow_box"><strong>접수/수납창구</strong></div>
                                <div className="box line_box arrow_box step_prev"><strong>진료실</strong></div>
                                ...
                                <div className="box line_box arrow_box"><strong>검사,촬영,투약 특수검사 예약</strong></div>
                                <div className="box end_box"><strong>귀가</strong></div>
                            </div>
                            <div className="step_box3 m_hide">
                                ...
                                <div className="box line_box arrow_box"><strong>원외 처방전 발급</strong></div>
                                {/* <div className="box line_box arrow_box"><strong>원내 약국에서 처방전 수령</strong></div> */}
                                <div className="box line_box"><strong>외부약국</strong></div>
                            </div>
                            <div className="pc_hide"><img src="/resource/images/reserv_info_step.png" alt="" /></div>
                        </div>
                    </div>
                </div>
            </div>
